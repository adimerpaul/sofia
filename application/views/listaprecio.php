...
<section class="panel">
    <header class="panel-heading">
        ...
        <div class="row">
            ...
            <div class="col-xs-6"><a href="<?=base_url()?>Listaprecios" class="btn btn-sm btn-info"> <i class="fa fa-refresh"></i> Actualizar</a></div>
        </div>
    </header>
        ...
        <form action="<?=base_url()?>Mispedidos/enviar" method="post">
            <table class="table table-bordered table-striped mb-none" id="datatable-default">
                ...
                <tr>
                    <th>Nombres</th>
                    <th>Cod</th>
                    <th class="hidden-phone">Precio Bajo</th>
                    <th class="hidden-phone">Precio Medio</th>
                    <th class="hidden-phone">Precio Mayor</th>
                </tr>
                </thead>
                <tbody>
                <?php
                $query=$this->db->query("SELECT * FROM `tbproductos` ORDER BY `tbproductos`.`Producto` ASC");
